...
Scan: 2026-06-03 20:58 UTC. Queue size: 719. Picks shown: 25.
...
- **Age in queue:** 30.0 days (source date: 2026-05-04, first seen: 2026-05-04)
...
- **Age in queue:** 35.0 days (source date: 2026-04-29, first seen: 2026-04-29)
...
- **Age in queue:** 63.9 days (source date: 2026-03-31, first seen: 2026-03-31)
...
- **Rank score:** 0.867 (silence=0.99 × importance=0.54 × age_factor)

- **Age in queue:** 18.4 days (source date: 2026-06-03, first seen: 2026-05-16)
...
- **Rank score:** 0.828 (silence=1.00 × importance=0.52 × age_factor)
...
- **Rank score:** 0.802 (silence=0.98 × importance=0.41 × age_factor)

- **Age in queue:** 29.9 days (source date: 2026-05-04, first seen: 2026-05-04)
...
- **Age in queue:** 41.0 days (source date: 2026-04-23, first seen: 2026-04-23)
...
- **Rank score:** 0.748 (silence=0.99 × importance=0.54 × age_factor)

- **Age in queue:** 12.3 days (source date: 2026-05-22, first seen: 2026-05-22)
...
- **Rank score:** 0.746 (silence=0.99 × importance=0.47 × age_factor)
...
- **Age in queue:** 6.5 days (source date: 2026-05-28, first seen: 2026-05-28)
...
- **Rank score:** 0.660 (silence=0.97 × importance=0.56 × age_factor)
...
- **Age in queue:** 5.7 days (source date: 2026-05-29, first seen: 2026-05-29)
...
- **Rank score:** 0.595 (silence=0.99 × importance=0.50 × age_factor)

- **Age in queue:** 6.3 days (source date: 2026-05-28, first seen: 2026-05-28)
...
- **Age in queue:** 1.7 days (source date: 2026-06-02, first seen: 2026-06-02)
...
- **Age in queue:** 4.3 days (source date: 2026-05-30, first seen: 2026-05-30)
...
- **Rank score:** 0.576 (silence=0.95 × importance=0.41 × age_factor)

- **Age in queue:** 14.2 days (source date: 2026-05-21, first seen: 2026-05-20)
...
- **Age in queue:** 13.3 days (source date: 2026-05-21, first seen: 2026-05-21)
...
- **Rank score:** 0.570 (silence=0.99 × importance=0.53 × age_factor)

- **Age in queue:** 2.7 days (source date: 2026-06-01, first seen: 2026-06-01)
...
- **Age in queue:** 7.2 days (source date: 2026-05-27, first seen: 2026-05-27)
...
### S21. keselamatan hakim digesa diperketat susulan kes pemandu didakwa. salim bashir berkata pendedahan kepada anc...
...
### S22. zara qairina inquest hears emotional mother-daughter audio recordings. kota kinabalu, may 18 &mdash; the co...

- **Rank score:** 0.546 (silence=0.86 × importance=0.41 × age_factor)

- **Age in queue:** 16.3 days (source date: 2026-05-19, first seen: 2026-05-18)
...
### S23. dakwaan bersatu kekal ‘magnet’ pengundi untuk tutup kemerosotan. penganalisis ahmad fauzi abdul hamid berka...
...
### S24. blue origin rocket explodes during test. the explosion is the latest setback for the space exploration comp...
...
### S25. lepas tembakan di tempat awam kesalahan serius, kata rayer. ahli parlimen rsn rayer turut menyoal sama ada ...

- **Rank score:** 0.532 (silence=0.97 × importance=0.47 × age_factor)

- **Age in queue:** 5.2 days (source date: 2026-05-29, first seen: 2026-05-29)
