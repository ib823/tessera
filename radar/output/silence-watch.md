...
Scan: 2026-06-10 05:39 UTC. Queue size: 785. Picks shown: 25.
...
- **Age in queue:** 36.4 days (source date: 2026-05-04, first seen: 2026-05-04)
...
- **Age in queue:** 41.4 days (source date: 2026-04-29, first seen: 2026-04-29)
...
- **Age in queue:** 70.3 days (source date: 2026-03-31, first seen: 2026-03-31)
...
- **Rank score:** 0.985 (silence=1.00 × importance=0.54 × age_factor)

- **Age in queue:** 24.8 days (source date: 2026-06-10, first seen: 2026-05-16)
...
- **Rank score:** 0.934 (silence=0.99 × importance=0.52 × age_factor)
...
- **Rank score:** 0.861 (silence=0.99 × importance=0.54 × age_factor)

- **Age in queue:** 18.7 days (source date: 2026-05-22, first seen: 2026-05-22)
...
- **Rank score:** 0.838 (silence=0.99 × importance=0.47 × age_factor)
...
- **Age in queue:** 36.3 days (source date: 2026-05-04, first seen: 2026-05-04)
...
- **Age in queue:** 47.4 days (source date: 2026-04-23, first seen: 2026-04-23)
...
- **Rank score:** 0.697 (silence=1.00 × importance=0.61 × age_factor)

- **Age in queue:** 4.1 days (source date: 2026-06-06, first seen: 2026-06-06)
...
- **Age in queue:** 19.7 days (source date: 2026-05-21, first seen: 2026-05-21)
...
- **Rank score:** 0.659 (silence=0.95 × importance=0.41 × age_factor)

- **Age in queue:** 20.5 days (source date: 2026-05-21, first seen: 2026-05-20)
...
- **Rank score:** 0.641 (silence=0.98 × importance=0.56 × age_factor)

- **Age in queue:** 4.7 days (source date: 2026-06-05, first seen: 2026-06-05)
...
- **Age in queue:** 3.9 days (source date: 2026-06-06, first seen: 2026-06-06)
...
- **Rank score:** 0.621 (silence=0.86 × importance=0.41 × age_factor)

- **Age in queue:** 22.7 days (source date: 2026-05-19, first seen: 2026-05-18)
...
- **Rank score:** 0.616 (silence=0.99 × importance=0.55 × age_factor)
...
- **Age in queue:** 4.9 days (source date: 2026-06-05, first seen: 2026-06-05)
...
### S18. wanita, 3 penjamin diperintah bayar pinjaman mara rm857,000. mahkamah tinggi putuskan penemuan mahkamah ses...

- **Rank score:** 0.575 (silence=0.99 × importance=0.48 × age_factor)

- **Age in queue:** 6.2 days (source date: 2026-06-03, first seen: 2026-06-03)
...
### S19. bentang laporan penuh audit afc, ahli parlimen seru fam. ramkarpal singh berkata orang awam ada hak tahu se...

- **Rank score:** 0.567 (silence=0.98 × importance=0.52 × age_factor)

- **Age in queue:** 3.7 days (source date: 2026-06-06, first seen: 2026-06-06)
...
### S20. saiful hazmi dilantik pengarah bahagian perundangan dan pendakwaan sprm. beliau menggantikan wan shaharuddi...

- **Rank score:** 0.560 (silence=0.99 × importance=0.47 × age_factor)

- **Age in queue:** 6.5 days (source date: 2026-06-03, first seen: 2026-06-03)
...
### S21. ahli parlimen sokong muafakat umno-pas, cadang masukkan gerakan hamzah. wan saiful wan jan berkata konsep f...

- **Rank score:** 0.544 (silence=0.98 × importance=0.47 × age_factor)

- **Age in queue:** 5.8 days (source date: 2026-06-04, first seen: 2026-06-04)
...
### S22. ahli pkr pertahan gantung akses mykhas bagi 2 ahli parlimen. timbalan setiausaha agung pkr, bryan ng, kata ...
...
### S23. pemimpin pkr pertahan gantung akses mykhas 2 ahli parlimen. timbalan setiausaha agung pkr, bryan ng, kata i...

- **Rank score:** 0.539 (silence=0.97 × importance=0.47 × age_factor)

- **Age in queue:** 5.7 days (source date: 2026-06-04, first seen: 2026-06-04)
...
### S24. gegaran dirasai di sabah susulan gempa bumi kuat di mindanao. met malaysia melaporkan gegaran dirasai di ta...

- **Rank score:** 0.538 (silence=0.98 × importance=0.52 × age_factor)

- **Age in queue:** 2.1 days (source date: 2026-06-08, first seen: 2026-06-08)
...
### S25. ahli parlimen cadang badan baharu urus persempadanan pilihan raya. saifuddin abdullah berkata spr tidak waj...

- **Rank score:** 0.538 (silence=0.99 × importance=0.47 × age_factor)

- **Age in queue:** 5.1 days (source date: 2026-06-05, first seen: 2026-06-05)
