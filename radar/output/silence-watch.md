...
Scan: 2026-06-02 10:27 UTC. Queue size: 703. Picks shown: 25.
...
- **Age in queue:** 33.6 days (source date: 2026-04-29, first seen: 2026-04-29)
...
- **Age in queue:** 62.5 days (source date: 2026-03-31, first seen: 2026-03-31)
...
- **Rank score:** 0.991 (silence=1.00 × importance=0.51 × age_factor)

- **Age in queue:** 28.6 days (source date: 2026-05-04, first seen: 2026-05-04)
...
- **Rank score:** 0.845 (silence=1.00 × importance=0.54 × age_factor)

- **Age in queue:** 17.0 days (source date: 2026-06-02, first seen: 2026-05-16)
...
- **Rank score:** 0.803 (silence=1.00 × importance=0.52 × age_factor)
...
- **Age in queue:** 39.6 days (source date: 2026-04-23, first seen: 2026-04-23)
...
- **Rank score:** 0.783 (silence=0.98 × importance=0.41 × age_factor)

- **Age in queue:** 28.5 days (source date: 2026-05-04, first seen: 2026-05-04)
...
- **Rank score:** 0.724 (silence=0.99 × importance=0.47 × age_factor)
...
- **Rank score:** 0.723 (silence=0.99 × importance=0.54 × age_factor)

- **Age in queue:** 10.9 days (source date: 2026-05-22, first seen: 2026-05-22)
...
- **Age in queue:** 5.1 days (source date: 2026-05-28, first seen: 2026-05-28)
...
- **Rank score:** 0.634 (silence=0.97 × importance=0.56 × age_factor)
...
- **Age in queue:** 4.3 days (source date: 2026-05-29, first seen: 2026-05-29)
...
- **Rank score:** 0.571 (silence=0.99 × importance=0.50 × age_factor)

- **Age in queue:** 4.9 days (source date: 2026-05-28, first seen: 2026-05-28)
...
- **Age in queue:** 0.3 days (source date: 2026-06-02, first seen: 2026-06-02)
...
- **Age in queue:** 2.9 days (source date: 2026-05-30, first seen: 2026-05-30)
...
- **Rank score:** 0.557 (silence=0.95 × importance=0.41 × age_factor)

- **Age in queue:** 12.7 days (source date: 2026-05-21, first seen: 2026-05-20)
...
- **Rank score:** 0.556 (silence=0.97 × importance=0.41 × age_factor)

- **Age in queue:** 11.9 days (source date: 2026-05-21, first seen: 2026-05-21)
...
### S19. kumpulan gesa undang-undang lindungi akses sama rata dana kawasan. projek sama buat gesaan selepas pejabat ...

- **Rank score:** 0.546 (silence=0.99 × importance=0.47 × age_factor)

- **Age in queue:** 5.7 days (source date: 2026-05-27, first seen: 2026-05-27)
...
### S20. 300 termasuk 12 pemimpin ajaran sesat ditahan di dewan sekolah. polis berkata program itu dikaitkan dengan ...

- **Rank score:** 0.545 (silence=0.99 × importance=0.53 × age_factor)

- **Age in queue:** 1.3 days (source date: 2026-06-01, first seen: 2026-06-01)
...
- **Age in queue:** 6.1 days (source date: 2026-05-27, first seen: 2026-05-27)
...
### S23. zara qairina inquest hears emotional mother-daughter audio recordings. kota kinabalu, may 18 &mdash; the co...

- **Rank score:** 0.529 (silence=0.86 × importance=0.41 × age_factor)

- **Age in queue:** 14.9 days (source date: 2026-05-19, first seen: 2026-05-18)
...
### S24. keselamatan hakim digesa diperketat susulan kes pemandu didakwa. salim bashir berkata pendedahan kepada anc...
...
- **Coverage:** 36 news, 1 social — pattern: _below-expected coverage_
