...
Scan: 2026-06-15 12:08 UTC. Queue size: 861. Picks shown: 25.
...
- **Age in queue:** 30.1 days (source date: 2026-06-15, first seen: 2026-05-16)
...
- **Age in queue:** 41.6 days (source date: 2026-05-04, first seen: 2026-05-04)
...
- **Age in queue:** 46.6 days (source date: 2026-04-29, first seen: 2026-04-29)
...
- **Age in queue:** 75.6 days (source date: 2026-03-31, first seen: 2026-03-31)
...
- **Rank score:** 0.954 (silence=0.99 × importance=0.54 × age_factor)

- **Age in queue:** 24.0 days (source date: 2026-05-22, first seen: 2026-05-22)
...
- **Age in queue:** 52.6 days (source date: 2026-04-23, first seen: 2026-04-23)
...
- **Rank score:** 0.729 (silence=0.97 × importance=0.41 × age_factor)

- **Age in queue:** 25.0 days (source date: 2026-05-21, first seen: 2026-05-21)
...
- **Rank score:** 0.728 (silence=0.95 × importance=0.41 × age_factor)

- **Age in queue:** 25.8 days (source date: 2026-05-21, first seen: 2026-05-20)
...
- **Rank score:** 0.683 (silence=0.86 × importance=0.41 × age_factor)

- **Age in queue:** 27.9 days (source date: 2026-05-19, first seen: 2026-05-18)
...
- **Age in queue:** 0.3 days (source date: 2026-06-15, first seen: 2026-06-15)
...
- **Age in queue:** 1.1 days (source date: 2026-06-14, first seen: 2026-06-14)
...
- **Age in queue:** 4.1 days (source date: 2026-06-11, first seen: 2026-06-11)
...
### S16. tak usah berlagak angkuh, kamil beritahu zahid. pegawai pm bidas kenyataan pengerusi bn bahawa kerajaan per...
...
### S17. tok batin difitnah sorok jaslinda, orang asli lapor polis. laporan dibuat susulan kandungan tular dakwa seo...
...
### S18. pas, bersatu tak boleh terus bawah payung sama, kata fadhli. ketua penerangan pas itu berkata ia susulan ke...

- **Rank score:** 0.545 (silence=0.97 × importance=0.47 × age_factor)

- **Age in queue:** 6.4 days (source date: 2026-06-09, first seen: 2026-06-09)
...
### S19. ketua pembangkang dipilih ahli parlimen, bukan pn. ahli parlimen indera mahkota saifuddin abdullah dan timb...

- **Rank score:** 0.533 (silence=0.99 × importance=0.52 × age_factor)

- **Age in queue:** 1.3 days (source date: 2026-06-14, first seen: 2026-06-14)
...
### S20. pas tak perlu 112, cukup jadi ‘blok terbesar’, kata ahli parlimen pkr. ahli parlimen bayan baru sim tze tzi...

- **Rank score:** 0.517 (silence=0.97 × importance=0.47 × age_factor)

- **Age in queue:** 4.3 days (source date: 2026-06-11, first seen: 2026-06-11)
...
### S21. akmal mohon semakan kehakiman terhadap pendakwaan. dr akmal saleh, mahu mahkamah batal keputusan peguam neg...

- **Rank score:** 0.514 (silence=0.98 × importance=0.47 × age_factor)
...
### S22. smk kuala perlis sekolah pertama terima pengiktirafan google for education. pengiktirafan itu susulan pelak...

- **Rank score:** 0.512 (silence=1.00 × importance=0.47 × age_factor)

- **Age in queue:** 3.2 days (source date: 2026-06-12, first seen: 2026-06-12)
...
### S23. mahkamah cyprus perintah sita vila mewah jho low. mahkamah daerah nicosia keluar susulan permohonan bersama...

- **Rank score:** 0.510 (silence=0.98 × importance=0.46 × age_factor)
...
### S24. fahmi kesal lee letak jawatan mpp. ketua penerangan pkr berkata, ahli parlimen pj sepatutnya guna mpp sebag...

- **Rank score:** 0.508 (silence=0.99 × importance=0.47 × age_factor)

- **Age in queue:** 3.0 days (source date: 2026-06-12, first seen: 2026-06-12)
...
### S25. thomas gagal heret idrus dalam saman bekas ahli parlimen. hakim berkata kerajaan akan turut bertanggungjawa...

- **Rank score:** 0.506 (silence=0.98 × importance=0.47 × age_factor)
