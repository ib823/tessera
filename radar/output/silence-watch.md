...
Scan: 2026-06-12 17:07 UTC. Queue size: 848. Picks shown: 25.
...
- **Rank score:** 1.031 (silence=1.00 × importance=0.54 × age_factor)
...
- **Age in queue:** 72.8 days (source date: 2026-03-31, first seen: 2026-03-31)
...
- **Rank score:** 0.982 (silence=1.00 × importance=0.52 × age_factor)
...
- **Rank score:** 0.904 (silence=0.99 × importance=0.54 × age_factor)
...
- **Rank score:** 0.888 (silence=1.00 × importance=0.47 × age_factor)
...
- **Rank score:** 0.748 (silence=1.00 × importance=0.61 × age_factor)
...
- **Rank score:** 0.692 (silence=0.97 × importance=0.41 × age_factor)
...
- **Rank score:** 0.691 (silence=0.95 × importance=0.41 × age_factor)

- **Age in queue:** 23.0 days (source date: 2026-05-21, first seen: 2026-05-20)
...
- **Rank score:** 0.687 (silence=0.98 × importance=0.56 × age_factor)

- **Age in queue:** 7.2 days (source date: 2026-06-05, first seen: 2026-06-05)
...
- **Rank score:** 0.661 (silence=0.99 × importance=0.55 × age_factor)
...
- **Rank score:** 0.650 (silence=0.86 × importance=0.41 × age_factor)
...
- **Age in queue:** 7.0 days (source date: 2026-06-06, first seen: 2026-06-05)
...
- **Rank score:** 0.529 (silence=0.98 × importance=0.52 × age_factor)

- **Age in queue:** 1.3 days (source date: 2026-06-11, first seen: 2026-06-11)
