...
Scan: 2026-06-10 22:42 UTC. Queue size: 807. Picks shown: 25.
...
- **Age in queue:** 37.1 days (source date: 2026-05-04, first seen: 2026-05-04)
...
- **Age in queue:** 42.1 days (source date: 2026-04-29, first seen: 2026-04-29)
...
### S3. budget 2027 presentation

- **Rank score:** 0.999 (silence=1.00 × importance=0.54 × age_factor)

- **Age in queue:** 25.5 days (source date: 2026-06-10, first seen: 2026-05-16)
...
- **Age in queue:** 71.0 days (source date: 2026-03-31, first seen: 2026-03-31)
...
- **Rank score:** 0.950 (silence=1.00 × importance=0.52 × age_factor)
...
- **Rank score:** 0.873 (silence=0.99 × importance=0.54 × age_factor)

- **Age in queue:** 19.4 days (source date: 2026-05-22, first seen: 2026-05-22)
...
- **Rank score:** 0.855 (silence=0.99 × importance=0.47 × age_factor)
...
- **Age in queue:** 37.0 days (source date: 2026-05-04, first seen: 2026-05-04)
...
- **Age in queue:** 48.1 days (source date: 2026-04-23, first seen: 2026-04-23)
...
- **Rank score:** 0.712 (silence=1.00 × importance=0.61 × age_factor)

- **Age in queue:** 4.8 days (source date: 2026-06-06, first seen: 2026-06-06)
...
- **Rank score:** 0.669 (silence=0.97 × importance=0.41 × age_factor)

- **Age in queue:** 20.4 days (source date: 2026-05-21, first seen: 2026-05-21)
...
- **Rank score:** 0.668 (silence=0.95 × importance=0.41 × age_factor)

- **Age in queue:** 21.2 days (source date: 2026-05-21, first seen: 2026-05-20)
...
- **Rank score:** 0.629 (silence=0.86 × importance=0.41 × age_factor)

- **Age in queue:** 23.4 days (source date: 2026-05-19, first seen: 2026-05-18)
...
- **Rank score:** 0.629 (silence=0.99 × importance=0.55 × age_factor)
...
- **Rank score:** 0.587 (silence=0.99 × importance=0.48 × age_factor)

- **Age in queue:** 7.0 days (source date: 2026-06-03, first seen: 2026-06-03)
...
### S20. ahli parlimen sokong muafakat umno-pas, cadang masukkan gerakan hamzah. wan saiful wan jan berkata konsep f...

- **Rank score:** 0.555 (silence=0.98 × importance=0.47 × age_factor)

- **Age in queue:** 6.5 days (source date: 2026-06-04, first seen: 2026-06-04)
...
### S21. ahli pkr pertahan gantung akses mykhas bagi 2 ahli parlimen. timbalan setiausaha agung pkr, bryan ng, kata ...
...
### S23. gegaran dirasai di sabah susulan gempa bumi kuat di mindanao. met malaysia melaporkan gegaran dirasai di ta...

- **Rank score:** 0.550 (silence=0.98 × importance=0.52 × age_factor)

- **Age in queue:** 2.8 days (source date: 2026-06-08, first seen: 2026-06-08)
...
- **Age in queue:** 5.8 days (source date: 2026-06-05, first seen: 2026-06-05)
